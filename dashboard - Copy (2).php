  ...
  <div class="zcontainer">
    ...
    <div class="navbar-collapse collapse">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href=""><span class="glyphicon glyphicon-user">&nbsp</span>Welcome <?php echo $_SESSION['NAMA_DEPAN']; echo $_SESSION['NAMA_BELAKANG']; ?> </a></li>
  ...
  <div id="sidebar-wrapper">
    <ul class="sidebar-nav">
      ...
      <!--	        <li <?php if($_REQUEST['select'] == 1) { echo 'class="active"';} ?> >
	            <a href="dashboard.php?select=1"><span class="glyphicon glyphicon-tasks">&nbsp</span>Dashboard <span class="badge">14</span></a>
	        </li>-->
      <li <?php if($_REQUEST['select'] == 2) { echo 'class="active"';} ?> > <a href="dashboard.php?select=2"><span class="glyphicon glyphicon-open">&nbsp</span>Entry Data</a> </li>
      ...
      <form action="">
        <div class="panel panel-default">
          ...
          <div class="panel-body"> 
            ...
            <div class="row"> 
              ...
              <!--  No Kontrak + PPN IDR-->
              <div class="col-lg-3">
                <div class="input-group"> <span class="input-group-addon">IDR</span>
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body"> 
            ...
            <div class="row">
              ...
              <div class="col-lg-2">
                <div class="input-group"> <span class="input-group-addon">Tgl</span> 
                  ...
                  <input type="text" class="form-control" placeholder="Tgl Masuk" data-date-format="mm/dd/yyyy" >
                </div>
                <!-- /input-group --> 
              </div>
              <!-- /.col-lg-4 --> 
            ...
            <div class="row"> 
              <!--              <div class="col-lg-4">
                <div class="input-group"> <span class="input-group-addon">asdf
                  <select >
                    <option value="#" disabled>Currency</option>
                    <option>IDR</option>
                    <option>USD</option>
            ...
            <!-- /.row                             <input type="text" class="form-control" placeholder="Amount">--> 
