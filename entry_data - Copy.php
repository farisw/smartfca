            ...
            <div class="row"> 
              ...
              <div class="col-lg-12">
                <div class="input-group"> <span class="input-group-addon">Nama Mitra &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                  <input type="text" class="form-control" placeholder="Nama Mitra" id="nama_mitra" value="nama_mitra">
                </div>
                <!-- /input-group --> 
              </div>
              <!-- /.col-lg-6 --> 
            ...
            <div class="row"> 
              ...
              <div class="col-lg-12">
                <div class="input-group"> <span class="input-group-addon">Nama Projek &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                  <input type="text" class="form-control" placeholder="Nama Projek" id="nama_proyek" value="nama_proyek">
                </div>
                <!-- /input-group --> 
              </div>
              <!-- /.col-lg-6 --> 
